/**
 * Interface for Object CID
 */
export interface defCID {
    [index: string]: object;
}

/**
 * Interface for Objects Events
 */
export interface defEvents {
    [index: string]: string;
}

export const dpCID: defCID = {
    subscriber: {
        type: 'string',
        role: 'text',
        name: 'Subscriber', // 4 Digit, 0-9,B-F
        read: true,
        write: false,
        def: '',
    },
    ...
    sensor: {
        type: 'string',
        role: 'text',
        name: 'Sensor', // Sensor or Zone number, 3 Digit, 0-9, B-F
        read: true,
        write: false,
        def: '',
    },
    message: {
        type: 'string',
        role: 'text',
        name: 'Message', // complete CID Message
        read: true,
        write: false,
        def: '',
    },
